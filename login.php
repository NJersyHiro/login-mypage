            ...
            <form action="mypage.php" method="post">
                <div class="form_contents">
                    ...
                    <div class="password">
                        ...
                        <input type="text" class="formbox" size="40" value="<?php if(isset($_COOKIE['login_keep']))echo $_COOKIE['password']?>" name="password">
                    </div>
                    <div class="login_check">
                        <label><input type="checkbox" class="checkbox" size="40" name="login_keep" value="login_keep"
                        <?php
